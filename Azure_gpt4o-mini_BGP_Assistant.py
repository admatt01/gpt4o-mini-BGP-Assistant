...
async def execute_tool(tool_call):
    ...
    try:
        if tool_name == "get_bgp_asn_details":
            result = await get_bgp_asn_details(arguments)
        elif tool_name == "view_asn_prefixes":
            result = await view_asn_prefixes(arguments)
        elif tool_name == "view_asn_peers":
            result = await view_asn_peers(arguments)
        elif tool_name == "view_asn_upstreams":
            result = await view_asn_upstreams(arguments)
        elif tool_name == "view_asn_downstreams":
            result = await view_asn_downstreams(arguments)
        elif tool_name == "view_prefix_details":
            result = await view_prefix_details(arguments)
        elif tool_name == "view_ip_address_details":
            result = await view_ip_address_details(arguments)
        elif tool_name == "search_org_details":
            result = await search_org_details(arguments)
        else:
